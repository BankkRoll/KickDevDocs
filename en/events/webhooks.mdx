---
title: "Webhooks"
description: "Set up webhooks for events with the Kick Public API"
icon: "webhook"
keywords: ['webhooks', 'events', 'kick api']
---
...
<Card title="Get Public Key" icon="key" href="../apis/public-key">
